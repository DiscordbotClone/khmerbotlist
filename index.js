...
client.on('ready',async () => {
    console.log("(!) Bot "+client.user.tag+" has been online.");
    let botsSchema = require("./src/database/models/botlist/bots.js");
    const bots = await botsSchema.find();
    client.user.setPresence({ activity: { type: 'WATCHING', name: 'tenbotkh.xyz | '+bots.length+' bots' }, status: "online" });
})
/*=======================================================================================*/
...
client.login("ODE4Mzc1ODY4NzcwNTQ5NzYw.YEXJ6w.5w1WBkoGwPsROiI62WalU9bWePI");
/*=======================================================================================*/
